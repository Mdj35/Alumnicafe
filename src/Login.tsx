    ...
    <div className="flex h-screen w-screen items-center justify-center bg-gray-50 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] overflow-hidden relative">
      ...
      >
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <button 
            type="submit"
            className="w-full py-4 mt-4 bg-hcdc-red hover:bg-[#A01E1F] text-white font-black rounded-2xl shadow-xl shadow-hcdc-red/20 transition-all hover:-translate-y-1 active:scale-95 uppercase tracking-wider text-sm flex items-center justify-center gap-2"
          >
            Access Terminal
          </button>
        </form>
